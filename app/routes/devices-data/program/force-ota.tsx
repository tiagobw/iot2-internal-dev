...
import { useForceOta } from '~/routes/devices-data/program/use-force-ota';

export type Props = {
  deviceId: number;
};

export function ForceOta({ deviceId }: Props) {
  const { callback, data, isLoading } = useForceOta(deviceId);
